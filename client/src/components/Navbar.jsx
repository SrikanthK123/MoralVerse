                            ...
                            {user ? (
                                <>
                                    ...
                                    {user.role === 'admin' && (
                                        <Link
                                            to="/admin"
                                            className="text-slate-800 hover:text-slate-900 block px-3 py-2 rounded-md text-base font-black uppercase tracking-widest italic font-mono flex items-center gap-2"
                                        >
